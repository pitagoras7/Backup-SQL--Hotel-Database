...
CREATE TABLE `ocupation` (
  `ocupation_id` int(11) NOT NULL AUTO_INCREMENT,
  `huesped_id` int(11) DEFAULT NULL,
  `location_id` int(11) DEFAULT NULL,
  `validated` datetime DEFAULT NULL,
  `ocupation_type` int(11) DEFAULT NULL,
  `estatu` varchar(20) DEFAULT NULL,
  `ocupation_subtype` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
-- Dump completed on 2017-06-19  5:48:24
